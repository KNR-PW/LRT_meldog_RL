...
def some_public_function(x: int):
    print("[meldog_simple_locomotion_policy] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[meldog_simple_locomotion_policy] startup")
    ...
    def on_shutdown(self):
        print("[meldog_simple_locomotion_policy] shutdown")