...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["locomotion", "perception"],
        help="Domain of the model.",
    )
    parser.add_argument(
        "--log-dir", type=str, required=True, help="Path to the training log directory."
    )
    parser.add_argument(
        "--tag", type=str, required=True, help="Release tag (e.g., v1.0-rough, v2.1-flat-obs)."
    )
    parser.add_argument(
        "--message",
        "-m",
